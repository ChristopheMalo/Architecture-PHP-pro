 ...
 * Ce script n'est pas envoyé sur github
 * User et Mot de passe ne doivent pas être divulgué
 * Un fichier générique est envoyé à la place
 * 
 ...
 * 
 * @commentaire v1.0.1 : insert datas pour table commentaire
 *              v1.0.2 : insert datas pour t_user + update t_comment
 */
-- --------------------------------------
-- CREATION D'UN JEU DE DONNÉES DE TEST
-- --------------------------------------
...
/* raw password is 'john' - Role user */
...
/* raw password is 'jane' - Role user */
INSERT INTO t_user VALUES
...
/* raw password is '@dm1n' - Role admin */
insert into t_user values
